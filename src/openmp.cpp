...
int get_num_threads() { return omp_get_num_threads(); }

int get_num_procs() { return omp_get_num_procs(); }

void set_num_threads(int nt) { return omp_set_num_threads(nt); }

void set_dynamic(int flag) { return omp_set_dynamic(flag); }
